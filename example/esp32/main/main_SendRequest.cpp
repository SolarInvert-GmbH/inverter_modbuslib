...
inline std::array<char, 17> printTimestamp(const std::chrono::microseconds t)
{
...
extern "C" void app_main(void)
{
    ...
    static constexpr auto tx0 = catta::esp32::Pin::gp22();
    static constexpr auto rx0 = catta::esp32::Pin::gp23();

    static constexpr auto tx1 = catta::esp32::Pin::gp12();
    static constexpr auto rx1 = catta::esp32::Pin::gp14();
    ...
    static catta::esp32::Uart uartJson = catta::esp32::Uart::device1(tx0, rx0, baudrate0, parity0, dataBits0, stopBits0);
    static catta::esp32::Uart uartModbus = catta::esp32::Uart::device2(tx1, rx1, baudrate1, parity1, dataBits1, stopBits1);
    static auto modbus = catta::modbus::MasterUart(requestTimeout, dataTimeout, stayInError, waitForIdle);

    static catta::tomodbus::Serializer<catta::modbus::si::request::Request> serializer;
    static catta::frommodbus::Parser<catta::modbus::si::response::Response> parser;

    static catta::modbus::MasterUartState state;
    static catta::modbus::MasterUartState error;

    static std::optional<std::uint8_t> receivedByte = {};
    static std::optional<std::uint8_t> sendByte = {};
    static catta::modbus::Token sendToken = {};
    static catta::modbus::Token receiveToken = {};

    static std::optional<char> receivedCharacter = {};
    static catta::fromstring::Parser<catta::modbus::si::request::Request> jsonParser = {};
    static catta::modbus::si::request::Request request = {};
    ...
    static LineBuffer sendLine;
    static LineBuffer receiveLine;
    ...
    auto next = catta::esp32::Time::get() + std::chrono::seconds{1};
    print("Modbus demo\r\n");
    while (true)
    {
