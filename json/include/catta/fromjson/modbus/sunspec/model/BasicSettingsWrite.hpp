...
{
template <>
class Parser<catta::modbus::sunspec::model::BasicSettingsWrite>
{
  public:
    using Error = catta::state::DefaultError;
    using Input = catta::json::Token;
    using Output = catta::modbus::sunspec::model::BasicSettingsWrite;
  ...
  private:
    ...
    Parser<catta::modbus::sunspec::ValueU16> _ecpNomHzParser;
    Parser<catta::modbus::sunspec::ValueU16> _vMaxParser;
    Parser<catta::modbus::sunspec::ValueU16> _vMinParser;
    Parser<catta::modbus::sunspec::ValueU16> _wMaxParser;
