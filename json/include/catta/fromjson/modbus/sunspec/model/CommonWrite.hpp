...
{
template <>
class Parser<catta::modbus::sunspec::model::CommonWrite>
{
  public:
    using Error = catta::state::DefaultError;
    using Input = catta::json::Token;
    using Output = catta::modbus::sunspec::model::CommonWrite;
    ...
    [[nodiscard]] constexpr Output data() const noexcept { return _state == DONE ? Output::create(_deviceAddressParser.data()) : Output::empty(); }
