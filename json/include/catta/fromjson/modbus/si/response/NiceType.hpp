...
{
template <>
class Parser<catta::modbus::si::response::NiceType>
{
  public:
    using Error = catta::state::DefaultError;
    using Input = catta::json::Token;
    using Output = catta::modbus::si::response::NiceType;
    [[nodiscard]] constexpr std::tuple<Error, catta::parser::InputHandled> read(const Input& input) noexcept
    {
        ...
        switch (_state)
        {
            ...
            case HUB + 0:
                return input == catta::json::Token::character('w')   ? jump(HUB + 193)
                       : input == catta::json::Token::character('s') ? jump(HUB + 133)
            ...
            case HUB + 103:
                return input == catta::json::Token::character('R')   ? jump(HUB + 125)
                       : input == catta::json::Token::character('O') ? jump(HUB + 109)
            ...
            case HUB + 126:
                return input == catta::json::Token::character('g') ? jump(HUB + 127) : error();
            case HUB + 127:
                return input == catta::json::Token::character('i') ? jump(HUB + 128) : error();
            case HUB + 128:
                return input == catta::json::Token::character('s') ? jump(HUB + 129) : error();
            case HUB + 129:
            ...
            case HUB + 133:
                return input == catta::json::Token::character('w')   ? jump(HUB + 166)
                       : input == catta::json::Token::character('t') ? jump(HUB + 147)
                       : input == catta::json::Token::character('e') ? jump(HUB + 134)
                                                                     : error();
            case HUB + 134:
                return input == catta::json::Token::character('t') ? jump(HUB + 135) : error();
            case HUB + 135:
                return input == catta::json::Token::character('P') ? jump(HUB + 136) : error();
            case HUB + 136:
                return input == catta::json::Token::character('o') ? jump(HUB + 137) : error();
            case HUB + 137:
                return input == catta::json::Token::character('w') ? jump(HUB + 138) : error();
            case HUB + 138:
                return input == catta::json::Token::character('e') ? jump(HUB + 139) : error();
            case HUB + 139:
                return input == catta::json::Token::character('r') ? jump(HUB + 140) : error();
            case HUB + 140:
                return input == catta::json::Token::character('F') ? jump(HUB + 141) : error();
            case HUB + 141:
                return input == catta::json::Token::character('a') ? jump(HUB + 142) : error();
            case HUB + 142:
                return input == catta::json::Token::character('c') ? jump(HUB + 143) : error();
            case HUB + 143:
                return input == catta::json::Token::character('t') ? jump(HUB + 144) : error();
            case HUB + 144:
                return input == catta::json::Token::character('o') ? jump(HUB + 145) : error();
            case HUB + 145:
            ...
            case HUB + 150:
                return input == catta::json::Token::character('C') ? jump(HUB + 151) : error();
            case HUB + 151:
                return input == catta::json::Token::character('o') ? jump(HUB + 152) : error();
            case HUB + 152:
                return input == catta::json::Token::character('n') ? jump(HUB + 153) : error();
            case HUB + 153:
            ...
            case HUB + 156:
                return input == catta::json::Token::character('n') ? jump(HUB + 157) : error();
            case HUB + 157:
                return input == catta::json::Token::character('t') ? jump(HUB + 158) : error();
            case HUB + 158:
                return input == catta::json::Token::character('V') ? jump(HUB + 159) : error();
            case HUB + 159:
                return input == catta::json::Token::character('o') ? jump(HUB + 160) : error();
            case HUB + 160:
                return input == catta::json::Token::character('l') ? jump(HUB + 161) : error();
            case HUB + 161:
                return input == catta::json::Token::character('t') ? jump(HUB + 162) : error();
            case HUB + 162:
                return input == catta::json::Token::character('a') ? jump(HUB + 163) : error();
            case HUB + 163:
                return input == catta::json::Token::character('g') ? jump(HUB + 164) : error();
            case HUB + 164:
                return input == catta::json::Token::character('e') ? jump(HUB + 165) : error();
            case HUB + 165:
                return input == catta::json::Token::closeString() ? close(9) : error();
            case HUB + 166:
                return input == catta::json::Token::character('i') ? jump(HUB + 167) : error();
            case HUB + 167:
                return input == catta::json::Token::character('t') ? jump(HUB + 168) : error();
            case HUB + 168:
            ...
            case HUB + 171:
                return input == catta::json::Token::character('n')   ? jump(HUB + 183)
                       : input == catta::json::Token::character('f') ? jump(HUB + 172)
                                                                     : error();
            case HUB + 172:
                return input == catta::json::Token::character('f') ? jump(HUB + 173) : error();
            case HUB + 173:
                return input == catta::json::Token::character('G') ? jump(HUB + 174) : error();
            case HUB + 174:
                return input == catta::json::Token::character('r') ? jump(HUB + 175) : error();
            case HUB + 175:
                return input == catta::json::Token::character('i') ? jump(HUB + 176) : error();
            case HUB + 176:
                return input == catta::json::Token::character('d') ? jump(HUB + 177) : error();
            case HUB + 177:
                return input == catta::json::Token::character('R') ? jump(HUB + 178) : error();
            case HUB + 178:
                return input == catta::json::Token::character('e') ? jump(HUB + 179) : error();
            case HUB + 179:
                return input == catta::json::Token::character('l') ? jump(HUB + 180) : error();
            case HUB + 180:
                return input == catta::json::Token::character('a') ? jump(HUB + 181) : error();
            case HUB + 181:
                return input == catta::json::Token::character('y') ? jump(HUB + 182) : error();
            case HUB + 182:
                return input == catta::json::Token::closeString() ? close(5) : error();
            case HUB + 183:
                return input == catta::json::Token::character('G') ? jump(HUB + 184) : error();
            case HUB + 184:
                return input == catta::json::Token::character('r') ? jump(HUB + 185) : error();
            case HUB + 185:
                return input == catta::json::Token::character('i') ? jump(HUB + 186) : error();
            case HUB + 186:
                return input == catta::json::Token::character('d') ? jump(HUB + 187) : error();
            case HUB + 187:
                return input == catta::json::Token::character('R') ? jump(HUB + 188) : error();
            case HUB + 188:
                return input == catta::json::Token::character('e') ? jump(HUB + 189) : error();
            case HUB + 189:
                return input == catta::json::Token::character('l') ? jump(HUB + 190) : error();
            case HUB + 190:
                return input == catta::json::Token::character('a') ? jump(HUB + 191) : error();
            case HUB + 191:
                return input == catta::json::Token::character('y') ? jump(HUB + 192) : error();
            case HUB + 192:
                return input == catta::json::Token::closeString() ? close(6) : error();
            case HUB + 193:
                return input == catta::json::Token::character('r') ? jump(HUB + 194) : error();
            case HUB + 194:
                return input == catta::json::Token::character('i') ? jump(HUB + 195) : error();
            case HUB + 195:
            ...
            case HUB + 199:
                return input == catta::json::Token::character('g') ? jump(HUB + 200) : error();
            case HUB + 200:
                return input == catta::json::Token::character('i') ? jump(HUB + 201) : error();
            case HUB + 201:
                return input == catta::json::Token::character('s') ? jump(HUB + 202) : error();
            case HUB + 202:
  ...
  private:
    ...
    static constexpr std::uint8_t TAIL = HUB + 206;
