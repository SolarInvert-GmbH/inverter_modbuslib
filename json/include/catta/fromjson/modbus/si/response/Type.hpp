...
class Parser<catta::modbus::si::response::Type>
{
  public:
    ...
    [[nodiscard]] constexpr std::tuple<Error, catta::parser::InputHandled> read(const Input& input) noexcept
    {
        ...
        switch (_state)
        {
            ...
            case HUB + 0:
                return input == catta::json::Token::character('u')   ? jump(HUB + 91)
                       : input == catta::json::Token::character('s') ? jump(HUB + 62)
                       : input == catta::json::Token::character('r') ? jump(HUB + 37)
                       : input == catta::json::Token::character('f') ? jump(HUB + 24)
                       : input == catta::json::Token::character('e') ? jump(HUB + 15)
            ...
            case HUB + 18:
                return input == catta::json::Token::character('p') ? jump(HUB + 19) : error();
            case HUB + 19:
                return input == catta::json::Token::character('t') ? jump(HUB + 20) : error();
            case HUB + 20:
                return input == catta::json::Token::character('i') ? jump(HUB + 21) : error();
            case HUB + 21:
                return input == catta::json::Token::character('o') ? jump(HUB + 22) : error();
            case HUB + 22:
                return input == catta::json::Token::character('n') ? jump(HUB + 23) : error();
            case HUB + 23:
            ...
            case HUB + 29:
                return input == catta::json::Token::character('y') ? jump(HUB + 30) : error();
            case HUB + 30:
                return input == catta::json::Token::character('V') ? jump(HUB + 31) : error();
            case HUB + 31:
            ...
            case HUB + 39:
                return input == catta::json::Token::character('d') ? jump(HUB + 40) : error();
            case HUB + 40:
                return input == catta::json::Token::character('O')   ? jump(HUB + 46)
                       : input == catta::json::Token::character('E') ? jump(HUB + 41)
                                                                     : error();
            case HUB + 41:
            ...
            case HUB + 43:
                return input == catta::json::Token::character('o') ? jump(HUB + 44) : error();
            case HUB + 44:
                return input == catta::json::Token::character('r') ? jump(HUB + 45) : error();
            case HUB + 45:
                return input == catta::json::Token::closeString() ? close(3) : error();
            case HUB + 46:
                return input == catta::json::Token::character('p') ? jump(HUB + 47) : error();
            case HUB + 47:
                return input == catta::json::Token::character('e') ? jump(HUB + 48) : error();
            case HUB + 48:
                return input == catta::json::Token::character('r') ? jump(HUB + 49) : error();
            case HUB + 49:
                return input == catta::json::Token::character('a') ? jump(HUB + 50) : error();
            case HUB + 50:
                return input == catta::json::Token::character('t') ? jump(HUB + 51) : error();
            case HUB + 51:
                return input == catta::json::Token::character('i') ? jump(HUB + 52) : error();
            case HUB + 52:
                return input == catta::json::Token::character('n') ? jump(HUB + 53) : error();
            case HUB + 53:
                return input == catta::json::Token::character('g') ? jump(HUB + 54) : error();
            case HUB + 54:
            ...
            case HUB + 58:
                return input == catta::json::Token::character('3') ? jump(HUB + 59) : error();
            case HUB + 59:
                return input == catta::json::Token::character('e')   ? jump(HUB + 61)
                       : input == catta::json::Token::character('3') ? jump(HUB + 60)
                                                                     : error();
            case HUB + 60:
            ...
            case HUB + 62:
                return input == catta::json::Token::character('u')   ? jump(HUB + 85)
                       : input == catta::json::Token::character('t') ? jump(HUB + 78)
                       : input == catta::json::Token::character('i') ? jump(HUB + 73)
                       : input == catta::json::Token::character('c') ? jump(HUB + 63)
                                                                     : error();
            case HUB + 63:
                return input == catta::json::Token::character('a') ? jump(HUB + 64) : error();
            case HUB + 64:
                return input == catta::json::Token::character('l') ? jump(HUB + 65) : error();
            case HUB + 65:
                return input == catta::json::Token::character('e') ? jump(HUB + 66) : error();
            case HUB + 66:
                return input == catta::json::Token::character('F') ? jump(HUB + 67) : error();
            case HUB + 67:
                return input == catta::json::Token::character('a') ? jump(HUB + 68) : error();
            case HUB + 68:
                return input == catta::json::Token::character('c') ? jump(HUB + 69) : error();
            case HUB + 69:
                return input == catta::json::Token::character('t') ? jump(HUB + 70) : error();
            case HUB + 70:
                return input == catta::json::Token::character('o') ? jump(HUB + 71) : error();
            case HUB + 71:
                return input == catta::json::Token::character('r') ? jump(HUB + 72) : error();
            case HUB + 72:
                return input == catta::json::Token::closeString() ? close(8) : error();
            case HUB + 73:
                return input == catta::json::Token::character('n') ? jump(HUB + 74) : error();
            case HUB + 74:
                return input == catta::json::Token::character('t') ? jump(HUB + 75) : error();
            case HUB + 75:
                return input == catta::json::Token::character('1') ? jump(HUB + 76) : error();
            case HUB + 76:
                return input == catta::json::Token::character('6') ? jump(HUB + 77) : error();
            case HUB + 77:
                return input == catta::json::Token::closeString() ? close(7) : error();
            case HUB + 78:
                return input == catta::json::Token::character('r') ? jump(HUB + 79) : error();
            case HUB + 79:
                return input == catta::json::Token::character('i') ? jump(HUB + 80) : error();
            case HUB + 80:
                return input == catta::json::Token::character('n') ? jump(HUB + 81) : error();
            case HUB + 81:
                return input == catta::json::Token::character('g') ? jump(HUB + 82) : error();
            case HUB + 82:
                return input == catta::json::Token::character('3') ? jump(HUB + 83) : error();
            case HUB + 83:
                return input == catta::json::Token::character('2') ? jump(HUB + 84) : error();
            case HUB + 84:
                return input == catta::json::Token::closeString() ? close(12) : error();
            case HUB + 85:
                return input == catta::json::Token::character('c') ? jump(HUB + 86) : error();
            case HUB + 86:
                return input == catta::json::Token::character('c') ? jump(HUB + 87) : error();
            case HUB + 87:
                return input == catta::json::Token::character('e') ? jump(HUB + 88) : error();
            case HUB + 88:
                return input == catta::json::Token::character('s') ? jump(HUB + 89) : error();
            case HUB + 89:
                return input == catta::json::Token::character('s') ? jump(HUB + 90) : error();
            case HUB + 90:
            ...
            case HUB + 93:
                return input == catta::json::Token::character('t') ? jump(HUB + 94) : error();
            case HUB + 94:
                return input == catta::json::Token::character('6')   ? jump(HUB + 99)
                       : input == catta::json::Token::character('3') ? jump(HUB + 97)
                       : input == catta::json::Token::character('1') ? jump(HUB + 95)
                                                                     : error();
            case HUB + 95:
                return input == catta::json::Token::character('6') ? jump(HUB + 96) : error();
            case HUB + 96:
                return input == catta::json::Token::closeString() ? close(6) : error();
            case HUB + 97:
                return input == catta::json::Token::character('2') ? jump(HUB + 98) : error();
            case HUB + 98:
                return input == catta::json::Token::closeString() ? close(10) : error();
            case HUB + 99:
                return input == catta::json::Token::character('4') ? jump(HUB + 100) : error();
            case HUB + 100:
  ...
  private:
    ...
    static constexpr std::uint8_t TAIL = HUB + 101;
