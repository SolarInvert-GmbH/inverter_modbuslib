...
class Parser<catta::modbus::si::request::Type>
{
  public:
    ...
    using Output = catta::modbus::si::request::Type;
    [[nodiscard]] constexpr std::tuple<Error, catta::parser::InputHandled> read(const Input& input) noexcept
    {
        ...
        switch (_state)
        {
            ...
            case HUB + 0:
                return input == catta::json::Token::character('w')   ? jump(HUB + 183)
                       : input == catta::json::Token::character('s') ? jump(HUB + 125)
                       : input == catta::json::Token::character('r') ? jump(HUB + 92)
                       : input == catta::json::Token::character('l') ? jump(HUB + 74)
                       : input == catta::json::Token::character('f') ? jump(HUB + 53)
            ...
            case HUB + 35:
                return input == catta::json::Token::character('n') ? jump(HUB + 36) : error();
            case HUB + 36:
            ...
            case HUB + 53:
                return input == catta::json::Token::character('o')   ? jump(HUB + 66)
                       : input == catta::json::Token::character('a') ? jump(HUB + 54)
                                                                     : error();
            case HUB + 54:
            ...
            case HUB + 58:
                return input == catta::json::Token::character('y') ? jump(HUB + 59) : error();
            case HUB + 59:
                return input == catta::json::Token::character('V') ? jump(HUB + 60) : error();
            case HUB + 60:
                return input == catta::json::Token::character('a') ? jump(HUB + 61) : error();
            case HUB + 61:
                return input == catta::json::Token::character('l') ? jump(HUB + 62) : error();
            case HUB + 62:
                return input == catta::json::Token::character('u') ? jump(HUB + 63) : error();
            case HUB + 63:
            ...
            case HUB + 68:
                return input == catta::json::Token::character('e') ? jump(HUB + 69) : error();
            case HUB + 69:
                return input == catta::json::Token::character('I') ? jump(HUB + 70) : error();
            case HUB + 70:
                return input == catta::json::Token::character('d') ? jump(HUB + 71) : error();
            case HUB + 71:
                return input == catta::json::Token::character('l') ? jump(HUB + 72) : error();
            case HUB + 72:
                return input == catta::json::Token::character('e') ? jump(HUB + 73) : error();
            case HUB + 73:
                return input == catta::json::Token::closeString() ? close(7) : error();
            case HUB + 74:
                return input == catta::json::Token::character('i') ? jump(HUB + 75) : error();
            case HUB + 75:
                return input == catta::json::Token::character('m') ? jump(HUB + 76) : error();
            case HUB + 76:
                return input == catta::json::Token::character('i') ? jump(HUB + 77) : error();
            case HUB + 77:
                return input == catta::json::Token::character('t') ? jump(HUB + 78) : error();
            case HUB + 78:
                return input == catta::json::Token::character('B') ? jump(HUB + 79) : error();
            case HUB + 79:
                return input == catta::json::Token::character('a') ? jump(HUB + 80) : error();
            case HUB + 80:
                return input == catta::json::Token::character('t') ? jump(HUB + 81) : error();
            case HUB + 81:
                return input == catta::json::Token::character('t') ? jump(HUB + 82) : error();
            case HUB + 82:
                return input == catta::json::Token::character('e') ? jump(HUB + 83) : error();
            case HUB + 83:
                return input == catta::json::Token::character('r') ? jump(HUB + 84) : error();
            case HUB + 84:
                return input == catta::json::Token::character('y') ? jump(HUB + 85) : error();
            case HUB + 85:
                return input == catta::json::Token::character('I') ? jump(HUB + 86) : error();
            case HUB + 86:
                return input == catta::json::Token::character('n') ? jump(HUB + 87) : error();
            case HUB + 87:
                return input == catta::json::Token::character('v') ? jump(HUB + 88) : error();
            case HUB + 88:
                return input == catta::json::Token::character('e') ? jump(HUB + 89) : error();
            case HUB + 89:
                return input == catta::json::Token::character('r') ? jump(HUB + 90) : error();
            case HUB + 90:
                return input == catta::json::Token::character('t') ? jump(HUB + 91) : error();
            case HUB + 91:
                return input == catta::json::Token::closeString() ? close(13) : error();
            case HUB + 92:
                return input == catta::json::Token::character('e') ? jump(HUB + 93) : error();
            case HUB + 93:
                return input == catta::json::Token::character('a') ? jump(HUB + 94) : error();
            case HUB + 94:
                return input == catta::json::Token::character('d') ? jump(HUB + 95) : error();
            case HUB + 95:
                return input == catta::json::Token::character('R')   ? jump(HUB + 117)
                       : input == catta::json::Token::character('O') ? jump(HUB + 101)
                       : input == catta::json::Token::character('E') ? jump(HUB + 96)
                                                                     : error();
            case HUB + 96:
            ...
            case HUB + 98:
                return input == catta::json::Token::character('o') ? jump(HUB + 99) : error();
            case HUB + 99:
                return input == catta::json::Token::character('r') ? jump(HUB + 100) : error();
            case HUB + 100:
                return input == catta::json::Token::closeString() ? close(14) : error();
            case HUB + 101:
                return input == catta::json::Token::character('p') ? jump(HUB + 102) : error();
            case HUB + 102:
            ...
            case HUB + 106:
                return input == catta::json::Token::character('i') ? jump(HUB + 107) : error();
            case HUB + 107:
            ...
            case HUB + 110:
                return input == catta::json::Token::character('a') ? jump(HUB + 111) : error();
            case HUB + 111:
                return input == catta::json::Token::character('t') ? jump(HUB + 112) : error();
            case HUB + 112:
                return input == catta::json::Token::character('a') ? jump(HUB + 113) : error();
            case HUB + 113:
                return input == catta::json::Token::character('3') ? jump(HUB + 114) : error();
            case HUB + 114:
                return input == catta::json::Token::character('e')   ? jump(HUB + 116)
                       : input == catta::json::Token::character('3') ? jump(HUB + 115)
                                                                     : error();
            case HUB + 115:
            ...
            case HUB + 117:
                return input == catta::json::Token::character('e') ? jump(HUB + 118) : error();
            case HUB + 118:
                return input == catta::json::Token::character('g') ? jump(HUB + 119) : error();
            case HUB + 119:
                return input == catta::json::Token::character('i') ? jump(HUB + 120) : error();
            case HUB + 120:
                return input == catta::json::Token::character('s') ? jump(HUB + 121) : error();
            case HUB + 121:
            ...
            case HUB + 125:
                return input == catta::json::Token::character('w')   ? jump(HUB + 158)
            ...
            case HUB + 161:
                return input == catta::json::Token::character('h') ? jump(HUB + 162) : error();
            case HUB + 162:
                return input == catta::json::Token::character('O') ? jump(HUB + 163) : error();
            case HUB + 163:
                return input == catta::json::Token::character('n')   ? jump(HUB + 174)
                       : input == catta::json::Token::character('f') ? jump(HUB + 164)
                                                                     : error();
            case HUB + 164:
                return input == catta::json::Token::character('f') ? jump(HUB + 165) : error();
            case HUB + 165:
                return input == catta::json::Token::character('I') ? jump(HUB + 166) : error();
            case HUB + 166:
                return input == catta::json::Token::character('n') ? jump(HUB + 167) : error();
            case HUB + 167:
                return input == catta::json::Token::character('v') ? jump(HUB + 168) : error();
            case HUB + 168:
                return input == catta::json::Token::character('e') ? jump(HUB + 169) : error();
            case HUB + 169:
                return input == catta::json::Token::character('r') ? jump(HUB + 170) : error();
            case HUB + 170:
                return input == catta::json::Token::character('t') ? jump(HUB + 171) : error();
            case HUB + 171:
                return input == catta::json::Token::character('e') ? jump(HUB + 172) : error();
            case HUB + 172:
                return input == catta::json::Token::character('r') ? jump(HUB + 173) : error();
            case HUB + 173:
            ...
            case HUB + 176:
                return input == catta::json::Token::character('v') ? jump(HUB + 177) : error();
            case HUB + 177:
                return input == catta::json::Token::character('e') ? jump(HUB + 178) : error();
            case HUB + 178:
                return input == catta::json::Token::character('r') ? jump(HUB + 179) : error();
            case HUB + 179:
            ...
            case HUB + 184:
                return input == catta::json::Token::character('i') ? jump(HUB + 185) : error();
            case HUB + 185:
                return input == catta::json::Token::character('t') ? jump(HUB + 186) : error();
            case HUB + 186:
                return input == catta::json::Token::character('e') ? jump(HUB + 187) : error();
            case HUB + 187:
                return input == catta::json::Token::character('R') ? jump(HUB + 188) : error();
            case HUB + 188:
                return input == catta::json::Token::character('e') ? jump(HUB + 189) : error();
            case HUB + 189:
                return input == catta::json::Token::character('g') ? jump(HUB + 190) : error();
            case HUB + 190:
                return input == catta::json::Token::character('i') ? jump(HUB + 191) : error();
            case HUB + 191:
                return input == catta::json::Token::character('s') ? jump(HUB + 192) : error();
            case HUB + 192:
                return input == catta::json::Token::character('t') ? jump(HUB + 193) : error();
            case HUB + 193:
                return input == catta::json::Token::character('e') ? jump(HUB + 194) : error();
            case HUB + 194:
                return input == catta::json::Token::character('r') ? jump(HUB + 195) : error();
            case HUB + 195:
  ...
  private:
    ...
    static constexpr std::uint8_t TAIL = HUB + 196;
