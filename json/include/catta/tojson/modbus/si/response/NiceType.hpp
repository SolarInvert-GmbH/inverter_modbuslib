...
{
template <>
class Serializer<catta::modbus::si::response::NiceType>
{
  public:
    using Error = catta::state::DefaultError;
    using Input = catta::modbus::si::response::NiceType;
  ...
  private:
    ...
    static constexpr std::uint16_t READ_REGISTER = WRITE_REGISTER + 13;
    static constexpr std::uint16_t TAIL = READ_REGISTER + 12;
