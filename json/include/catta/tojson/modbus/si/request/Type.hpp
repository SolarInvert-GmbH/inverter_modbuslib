...
{
template <>
class Serializer<catta::modbus::si::request::Type>
{
  public:
    using Error = catta::state::DefaultError;
    using Input = catta::modbus::si::request::Type;
  ...
  private:
    ...
    static constexpr std::uint16_t READ_REGISTER = START + 1;
    static constexpr std::uint16_t WRITE_REGISTER = READ_REGISTER + 12;
    ...
    static constexpr std::uint16_t READ_ERROR = LIMIT_BATTERY_INVERT + 18;
    static constexpr std::uint16_t TAIL = READ_ERROR + 9;
