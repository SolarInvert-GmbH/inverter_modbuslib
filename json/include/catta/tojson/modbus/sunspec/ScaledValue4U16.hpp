...
{
template <>
class Serializer<catta::modbus::sunspec::ScaledValue4U16>
{
  public:
    using Error = catta::state::DefaultError;
    using Input = catta::modbus::sunspec::ScaledValue4U16;
    ...
    [[nodiscard]] constexpr std::tuple<Error, catta::parser::InputHandled> read(const Input& input) noexcept
    {
        ...
        switch (_state)
        {
            ...
            case OVERALL + 10:
                return handle(_overallSerializer, input.overall(), catta::json::Token::comma());
            case PHASE_A + 0:
                return next(catta::json::Token::openString());
            case PHASE_A + 1:
  ...
  private:
    ...
    Serializer<catta::modbus::sunspec::ValueU16> _overallSerializer;
    ...
    static constexpr std::uint8_t OVERALL = START + 1;
    static constexpr std::uint8_t PHASE_A = OVERALL + 11;
