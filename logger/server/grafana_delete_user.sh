...
delete()
{
    ...
    LINES="$(curl -X DELETE -s -u "${VAR_USER_PASSWORD}" -H "Content-Type: application/json" "http://localhost:3000/api/admin/users/${VAR_USER}" 2>&1)"
    CODE="${?}"
