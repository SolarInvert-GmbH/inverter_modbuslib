...
// random
#include <catta/random/modbus/sunspec/model/Inverter.hpp>

// fromtostring
#include <catta/fromstring/modbus/sunspec/model/Inverter.hpp>
#include <catta/tostring/modbus/sunspec/model/Inverter.hpp>

// json
#include <catta/fromjson/modbus/sunspec/model/Inverter.hpp>
#include <catta/tojson/modbus/sunspec/model/Inverter.hpp>

// modbus
#include <catta/frommodbus/modbus/sunspec/model/Inverter.hpp>
#include <catta/tomodbus/modbus/sunspec/model/Inverter.hpp>
...
int main()
{
    using Type = catta::modbus::sunspec::model::Inverter;
