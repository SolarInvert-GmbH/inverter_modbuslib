...
// fromtostring
#include <catta/fromstring/modbus/si/response/FactoryValues.hpp>
#include <catta/tostring/modbus/si/response/FactoryValues.hpp>
...
int main()
{
    using Type = catta::modbus::si::response::FactoryValues;
