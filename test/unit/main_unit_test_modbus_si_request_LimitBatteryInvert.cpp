...
// fromtostring
#include <catta/fromstring/modbus/si/request/LimitBatteryInvert.hpp>
#include <catta/tostring/modbus/si/request/LimitBatteryInvert.hpp>
...
int main()
{
    using Type = catta::modbus::si::request::LimitBatteryInvert;
