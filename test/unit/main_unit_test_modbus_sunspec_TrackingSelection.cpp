...
// random
#include <catta/random/modbus/sunspec/TrackingSelection.hpp>

// fromtostring
#include <catta/fromstring/modbus/sunspec/TrackingSelection.hpp>
#include <catta/tostring/modbus/sunspec/TrackingSelection.hpp>

// json
#include <catta/fromjson/modbus/sunspec/TrackingSelection.hpp>
#include <catta/tojson/modbus/sunspec/TrackingSelection.hpp>
...
int main()
{
    using Type = catta::modbus::sunspec::TrackingSelection;
