...
// fromtostring
#include <catta/fromstring/modbus/si/request/ControlBatteryInvert.hpp>
#include <catta/tostring/modbus/si/request/ControlBatteryInvert.hpp>
...
int main()
{
    using Type = catta::modbus::si::request::ControlBatteryInvert;
