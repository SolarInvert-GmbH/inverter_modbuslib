...
// fromtostring
#include <catta/fromstring/modbus/si/response/ReadError.hpp>
#include <catta/tostring/modbus/si/response/ReadError.hpp>
...
int main()
{
    using Type = catta::modbus::si::response::ReadError;
