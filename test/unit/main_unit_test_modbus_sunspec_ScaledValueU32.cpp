...
// fromtostring
#include <catta/fromstring/modbus/sunspec/ScaledValueU32.hpp>
#include <catta/tostring/modbus/sunspec/ScaledValueU32.hpp>
...
int main()
{
    using Type = catta::modbus::sunspec::ScaledValueU32;
