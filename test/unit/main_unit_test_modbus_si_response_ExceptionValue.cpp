...
// fromtostring
#include <catta/fromstring/modbus/si/response/ExceptionValue.hpp>
#include <catta/tostring/modbus/si/response/ExceptionValue.hpp>
...
int main()
{
    using Type = catta::modbus::si::response::ExceptionValue;
