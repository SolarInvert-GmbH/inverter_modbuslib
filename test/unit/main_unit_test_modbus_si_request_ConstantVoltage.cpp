...
// fromtostring
#include <catta/fromstring/modbus/si/request/ConstantVoltage.hpp>
#include <catta/tostring/modbus/si/request/ConstantVoltage.hpp>
...
int main()
{
    using Type = catta::modbus::si::request::ConstantVoltage;
