...
// fromtostring
#include <catta/fromstring/modbus/si/request/PowerFactor.hpp>
#include <catta/tostring/modbus/si/request/PowerFactor.hpp>
...
int main()
{
    using Type = catta::modbus::si::request::PowerFactor;
