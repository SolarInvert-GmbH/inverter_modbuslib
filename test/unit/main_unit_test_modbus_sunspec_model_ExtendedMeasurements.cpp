...
// random
#include <catta/random/modbus/sunspec/model/ExtendedMeasurements.hpp>

// fromtostring
#include <catta/fromstring/modbus/sunspec/model/ExtendedMeasurements.hpp>
#include <catta/tostring/modbus/sunspec/model/ExtendedMeasurements.hpp>

// json
#include <catta/fromjson/modbus/sunspec/model/ExtendedMeasurements.hpp>
#include <catta/tojson/modbus/sunspec/model/ExtendedMeasurements.hpp>

// modbus
#include <catta/frommodbus/modbus/sunspec/model/ExtendedMeasurements.hpp>
#include <catta/tomodbus/modbus/sunspec/model/ExtendedMeasurements.hpp>
...
int main()
{
    using Type = catta::modbus::sunspec::model::ExtendedMeasurements;
