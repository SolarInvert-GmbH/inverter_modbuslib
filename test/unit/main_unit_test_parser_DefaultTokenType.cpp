...
// random
#include <catta/random/parser/DefaultTokenType.hpp>

// fromtostring
#include <catta/fromstring/parser/DefaultTokenType.hpp>
#include <catta/tostring/parser/DefaultTokenType.hpp>
