...
// random
#include <catta/random/modbus/sunspec/model/Nameplate.hpp>

// fromtostring
#include <catta/fromstring/modbus/sunspec/model/Nameplate.hpp>
#include <catta/tostring/modbus/sunspec/model/Nameplate.hpp>

// json
#include <catta/fromjson/modbus/sunspec/model/Nameplate.hpp>
#include <catta/tojson/modbus/sunspec/model/Nameplate.hpp>

// modbus
#include <catta/frommodbus/modbus/sunspec/model/Nameplate.hpp>
#include <catta/tomodbus/modbus/sunspec/model/Nameplate.hpp>
...
int main()
{
    using Type = catta::modbus::sunspec::model::Nameplate;
