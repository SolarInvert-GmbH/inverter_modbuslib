...
// fromtostring
#include <catta/fromstring/modbus/sunspec/ScaledValue2U16.hpp>
#include <catta/tostring/modbus/sunspec/ScaledValue2U16.hpp>
...
int main()
{
    using Type = catta::modbus::sunspec::ScaledValue2U16;
