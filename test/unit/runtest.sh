...
check automatic_test_modbus_si_response_NiceResponse
check automatic_test_modbus_si_response_NiceType
...
check automatic_test_modbus_sunspec_String16
check automatic_test_modbus_sunspec_String32
check automatic_test_modbus_sunspec_TrackingSelection
...
check automatic_test_modbus_ValueCache
