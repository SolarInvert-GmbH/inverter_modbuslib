...
// random
#include <catta/random/modbus/sunspec/model/ImmediateControls.hpp>

// fromtostring
#include <catta/fromstring/modbus/sunspec/model/ImmediateControls.hpp>
#include <catta/tostring/modbus/sunspec/model/ImmediateControls.hpp>

// json
#include <catta/fromjson/modbus/sunspec/model/ImmediateControls.hpp>
#include <catta/tojson/modbus/sunspec/model/ImmediateControls.hpp>

// modbus
#include <catta/frommodbus/modbus/sunspec/model/ImmediateControls.hpp>
#include <catta/tomodbus/modbus/sunspec/model/ImmediateControls.hpp>
...
int main()
{
    using Type = catta::modbus::sunspec::model::ImmediateControls;
