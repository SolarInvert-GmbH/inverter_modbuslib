...
// random
#include <catta/random/modbus/sunspec/model/CommonRead.hpp>

// fromtostring
#include <catta/fromstring/modbus/sunspec/model/CommonRead.hpp>
#include <catta/tostring/modbus/sunspec/model/CommonRead.hpp>

// json
#include <catta/fromjson/modbus/sunspec/model/CommonRead.hpp>
#include <catta/tojson/modbus/sunspec/model/CommonRead.hpp>

// modbus
#include <catta/frommodbus/modbus/sunspec/model/CommonRead.hpp>
#include <catta/tomodbus/modbus/sunspec/model/CommonRead.hpp>
...
int main()
{
    using Type = catta::modbus::sunspec::model::CommonRead;
