...
// fromtostring
#include <catta/fromstring/modbus/sunspec/ScaledValueS16.hpp>
#include <catta/tostring/modbus/sunspec/ScaledValueS16.hpp>
...
int main()
{
    using Type = catta::modbus::sunspec::ScaledValueS16;
    static_assert(catta::tojson::Serializable<Type>);
    static_assert(catta::fromjson::Parsable<Type>);
