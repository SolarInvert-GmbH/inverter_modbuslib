...
// random
#include <catta/random/modbus/sunspec/model/BasicSettingsRead.hpp>

// fromtostring
#include <catta/fromstring/modbus/sunspec/model/BasicSettingsRead.hpp>
#include <catta/tostring/modbus/sunspec/model/BasicSettingsRead.hpp>

// json
#include <catta/fromjson/modbus/sunspec/model/BasicSettingsRead.hpp>
#include <catta/tojson/modbus/sunspec/model/BasicSettingsRead.hpp>
...
int main()
{
    using Type = catta::modbus::sunspec::model::BasicSettingsRead;
