...
// fromtostring
#include <catta/fromstring/modbus/sunspec/ScaledValueU16.hpp>
#include <catta/tostring/modbus/sunspec/ScaledValueU16.hpp>
...
int main()
{
    using Type = catta::modbus::sunspec::ScaledValueU16;
