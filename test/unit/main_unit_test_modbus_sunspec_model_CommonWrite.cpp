...
// random
#include <catta/random/modbus/sunspec/model/CommonWrite.hpp>

// fromtostring
#include <catta/fromstring/modbus/sunspec/model/CommonWrite.hpp>
#include <catta/tostring/modbus/sunspec/model/CommonWrite.hpp>

// json
#include <catta/fromjson/modbus/sunspec/model/CommonWrite.hpp>
#include <catta/tojson/modbus/sunspec/model/CommonWrite.hpp>
...
int main()
{
    using Type = catta::modbus::sunspec::model::CommonWrite;
