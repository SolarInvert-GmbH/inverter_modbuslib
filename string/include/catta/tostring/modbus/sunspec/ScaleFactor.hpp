...
{
template <>
class GetName<catta::modbus::sunspec::ScaleFactor>
{
  public:
    static constexpr std::string_view name = "catta::modbus::sunspec::ScaleFactor";
};

template <>
class Serializer<catta::modbus::sunspec::ScaleFactor>
{
  public:
    using ToString = catta::tostring::json::ToString<catta::modbus::sunspec::ScaleFactor>;
