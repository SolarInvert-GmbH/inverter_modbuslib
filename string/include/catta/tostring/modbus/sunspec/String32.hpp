...
{
template <>
class GetName<catta::modbus::sunspec::String32>
{
  public:
    static constexpr std::string_view name = "catta::modbus::sunspec::String32";
};

template <>
class Serializer<catta::modbus::sunspec::String32>
{
  public:
    using Error = catta::state::DefaultError;
    using Input = catta::modbus::sunspec::String32;
    using Output = char;
