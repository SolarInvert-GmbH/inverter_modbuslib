...
{
template <>
class GetName<catta::modbus::sunspec::ScaledValueU32>
{
  public:
    static constexpr std::string_view name = "catta::modbus::sunspec::ScaledValueU32";
};
template <>
class Serializer<catta::modbus::sunspec::ScaledValueU32>
{
  public:
    using ToString = catta::tostring::json::ToString<catta::modbus::sunspec::ScaledValueU32>;
