...
{
template <>
class GetName<catta::modbus::sunspec::model::Inverter>
{
  public:
    static constexpr std::string_view name = "catta::modbus::sunspec::model::Inverter";
};
template <>
class Serializer<catta::modbus::sunspec::model::Inverter>
{
  public:
    using ToString = catta::tostring::json::ToString<catta::modbus::sunspec::model::Inverter>;
