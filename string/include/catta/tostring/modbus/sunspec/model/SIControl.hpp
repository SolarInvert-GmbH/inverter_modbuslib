...
{
template <>
class GetName<catta::modbus::sunspec::model::SIControl>
{
  public:
    static constexpr std::string_view name = "catta::modbus::sunspec::model::SIControl";
};
template <>
class Serializer<catta::modbus::sunspec::model::SIControl>
{
  public:
    using ToString = catta::tostring::json::ToString<catta::modbus::sunspec::model::SIControl>;
