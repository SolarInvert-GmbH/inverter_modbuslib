...
{
template <>
class GetName<catta::modbus::sunspec::model::BasicSettingsWrite>
{
  public:
    static constexpr std::string_view name = "catta::modbus::sunspec::model::BasicSettingsWrite";
};
template <>
class Serializer<catta::modbus::sunspec::model::BasicSettingsWrite>
{
  public:
    using ToString = catta::tostring::json::ToString<catta::modbus::sunspec::model::BasicSettingsWrite>;
