...
{
template <>
class GetName<catta::modbus::sunspec::model::CommonWrite>
{
  public:
    static constexpr std::string_view name = "catta::modbus::sunspec::model::CommonWrite";
};
template <>
class Serializer<catta::modbus::sunspec::model::CommonWrite>
{
  public:
    using ToString = catta::tostring::json::ToString<catta::modbus::sunspec::model::CommonWrite>;
