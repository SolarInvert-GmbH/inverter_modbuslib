...
{
template <>
class GetName<catta::modbus::sunspec::model::Nameplate>
{
  public:
    static constexpr std::string_view name = "catta::modbus::sunspec::model::Nameplate";
};
template <>
class Serializer<catta::modbus::sunspec::model::Nameplate>
{
  public:
    using ToString = catta::tostring::json::ToString<catta::modbus::sunspec::model::Nameplate>;
