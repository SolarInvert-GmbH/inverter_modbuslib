...
{
template <>
class GetName<catta::modbus::sunspec::model::ExtendedMeasurements>
{
  public:
    static constexpr std::string_view name = "catta::modbus::sunspec::model::ExtendedMeasurements";
};
template <>
class Serializer<catta::modbus::sunspec::model::ExtendedMeasurements>
{
  public:
    using ToString = catta::tostring::json::ToString<catta::modbus::sunspec::model::ExtendedMeasurements>;
