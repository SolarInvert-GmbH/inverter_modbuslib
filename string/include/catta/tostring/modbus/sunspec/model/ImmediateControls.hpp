...
{
template <>
class GetName<catta::modbus::sunspec::model::ImmediateControls>
{
  public:
    static constexpr std::string_view name = "catta::modbus::sunspec::model::ImmediateControls";
};
template <>
class Serializer<catta::modbus::sunspec::model::ImmediateControls>
{
  public:
    using ToString = catta::tostring::json::ToString<catta::modbus::sunspec::model::ImmediateControls>;
