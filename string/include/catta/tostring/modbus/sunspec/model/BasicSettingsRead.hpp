...
{
template <>
class GetName<catta::modbus::sunspec::model::BasicSettingsRead>
{
  public:
    static constexpr std::string_view name = "catta::modbus::sunspec::model::BasicSettingsRead";
};
template <>
class Serializer<catta::modbus::sunspec::model::BasicSettingsRead>
{
  public:
    using ToString = catta::tostring::json::ToString<catta::modbus::sunspec::model::BasicSettingsRead>;
