...
{
template <>
class GetName<catta::modbus::sunspec::ScaledValue3U16>
{
  public:
    static constexpr std::string_view name = "catta::modbus::sunspec::ScaledValue3U16";
};
template <>
class Serializer<catta::modbus::sunspec::ScaledValue3U16>
{
  public:
    using ToString = catta::tostring::json::ToString<catta::modbus::sunspec::ScaledValue3U16>;
