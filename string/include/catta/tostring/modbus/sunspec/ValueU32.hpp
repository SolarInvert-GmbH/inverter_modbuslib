...
{
template <>
class GetName<catta::modbus::sunspec::ValueU32>
{
  public:
    static constexpr std::string_view name = "catta::modbus::sunspec::ValueU32";
};

template <>
class Serializer<catta::modbus::sunspec::ValueU32>
{
  public:
    using ToString = catta::tostring::json::ToString<catta::modbus::sunspec::ValueU32>;
