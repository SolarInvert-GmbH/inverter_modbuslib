...
{
template <>
class GetName<catta::modbus::sunspec::ScaledValueU16>
{
  public:
    static constexpr std::string_view name = "catta::modbus::sunspec::ScaledValueU16";
};
template <>
class Serializer<catta::modbus::sunspec::ScaledValueU16>
{
  public:
    using ToString = catta::tostring::json::ToString<catta::modbus::sunspec::ScaledValueU16>;
