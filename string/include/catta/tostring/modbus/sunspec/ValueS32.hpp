...
// json
#include <catta/tojson/modbus/sunspec/ValueS32.hpp>
...
{
template <>
class GetName<catta::modbus::sunspec::ValueS32>
{
  public:
    static constexpr std::string_view name = "catta::modbus::sunspec::ValueS32";
};

template <>
class Serializer<catta::modbus::sunspec::ValueS32>
{
  public:
    using ToString = catta::tostring::json::ToString<catta::modbus::sunspec::ValueS32>;
