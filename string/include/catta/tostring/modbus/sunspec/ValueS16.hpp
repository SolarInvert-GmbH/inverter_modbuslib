...
{
template <>
class GetName<catta::modbus::sunspec::ValueS16>
{
  public:
    static constexpr std::string_view name = "catta::modbus::sunspec::ValueS16";
};

template <>
class Serializer<catta::modbus::sunspec::ValueS16>
{
  public:
    using ToString = catta::tostring::json::ToString<catta::modbus::sunspec::ValueS16>;
