...
{
template <>
class GetName<catta::modbus::sunspec::TrackingSelection>
{
  public:
    static constexpr std::string_view name = "catta::modbus::sunspec::TrackingSelection";
};
template <>
class Serializer<catta::modbus::sunspec::TrackingSelection>
{
  public:
    using ToString = catta::tostring::json::ToString<catta::modbus::sunspec::TrackingSelection>;
