...
{
template <>
class GetName<catta::modbus::si::PowerConfig>
{
  public:
    static constexpr std::string_view name = "catta::modbus::si::PowerConfig";
};
template <>
class Serializer<catta::modbus::si::PowerConfig>
{
  public:
    using ToString = catta::tostring::json::ToString<catta::modbus::si::PowerConfig>;
