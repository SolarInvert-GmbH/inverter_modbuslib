...
{
template <>
class GetName<catta::modbus::si::response::NiceResponse>
{
  public:
    static constexpr std::string_view name = "catta::modbus::si::response::NiceResponse";
};
template <>
class Serializer<catta::modbus::si::response::NiceResponse>
{
  public:
    using ToString = catta::tostring::json::ToString<catta::modbus::si::response::NiceResponse>;
