...
{
template <>
class GetName<catta::modbus::si::response::Type>
{
  public:
    static constexpr std::string_view name = "catta::modbus::si::response::Type";
};
template <>
class Serializer<catta::modbus::si::response::Type>
{
  public:
    using ToString = catta::tostring::json::ToString<catta::modbus::si::response::Type>;
