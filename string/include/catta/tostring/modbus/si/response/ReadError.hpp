...
{
template <>
class GetName<catta::modbus::si::response::ReadError>
{
  public:
    static constexpr std::string_view name = "catta::modbus::si::response::ReadError";
};
template <>
class Serializer<catta::modbus::si::response::ReadError>
{
  public:
    using ToString = catta::tostring::json::ToString<catta::modbus::si::response::ReadError>;
