...
{
template <>
class GetName<catta::modbus::si::response::Response>
{
  public:
    static constexpr std::string_view name = "catta::modbus::si::response::Response";
};
template <>
class Serializer<catta::modbus::si::response::Response>
{
  public:
    using ToString = catta::tostring::json::ToString<catta::modbus::si::response::Response>;
