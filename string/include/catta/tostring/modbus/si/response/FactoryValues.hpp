...
{
template <>
class GetName<catta::modbus::si::response::FactoryValues>
{
  public:
    static constexpr std::string_view name = "catta::modbus::si::response::FactoryValues";
};
template <>
class Serializer<catta::modbus::si::response::FactoryValues>
{
  public:
    using ToString = catta::tostring::json::ToString<catta::modbus::si::response::FactoryValues>;
