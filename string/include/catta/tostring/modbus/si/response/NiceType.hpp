...
{
template <>
class GetName<catta::modbus::si::response::NiceType>
{
  public:
    static constexpr std::string_view name = "catta::modbus::si::response::NiceType";
};
template <>
class Serializer<catta::modbus::si::response::NiceType>
{
  public:
    using ToString = catta::tostring::json::ToString<catta::modbus::si::response::NiceType>;
