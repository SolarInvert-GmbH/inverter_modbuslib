...
{
template <>
class GetName<catta::modbus::si::response::ReadOperatingData3e>
{
  public:
    static constexpr std::string_view name = "catta::modbus::si::response::ReadOperatingData3e";
};
template <>
class Serializer<catta::modbus::si::response::ReadOperatingData3e>
{
  public:
    using ToString = catta::tostring::json::ToString<catta::modbus::si::response::ReadOperatingData3e>;
