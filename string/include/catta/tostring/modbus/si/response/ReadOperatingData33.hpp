...
{
template <>
class GetName<catta::modbus::si::response::ReadOperatingData33>
{
  public:
    static constexpr std::string_view name = "catta::modbus::si::response::ReadOperatingData33";
};
template <>
class Serializer<catta::modbus::si::response::ReadOperatingData33>
{
  public:
    using ToString = catta::tostring::json::ToString<catta::modbus::si::response::ReadOperatingData33>;
