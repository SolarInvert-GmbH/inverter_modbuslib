...
{
template <>
class GetName<catta::modbus::si::WriteRegister>
{
  public:
    static constexpr std::string_view name = "catta::modbus::si::WriteRegister";
};
template <>
class Serializer<catta::modbus::si::WriteRegister>
{
  public:
    using ToString = catta::tostring::json::ToString<catta::modbus::si::WriteRegister>;
