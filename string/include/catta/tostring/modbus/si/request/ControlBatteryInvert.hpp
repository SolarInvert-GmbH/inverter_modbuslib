...
{
template <>
class GetName<catta::modbus::si::request::ControlBatteryInvert>
{
  public:
    static constexpr std::string_view name = "catta::modbus::si::request::ControlBatteryInvert";
};
template <>
class Serializer<catta::modbus::si::request::ControlBatteryInvert>
{
  public:
    using ToString = catta::tostring::json::ToString<catta::modbus::si::request::ControlBatteryInvert>;
