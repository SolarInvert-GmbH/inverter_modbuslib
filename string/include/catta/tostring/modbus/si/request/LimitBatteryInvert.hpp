...
{
template <>
class GetName<catta::modbus::si::request::LimitBatteryInvert>
{
  public:
    static constexpr std::string_view name = "catta::modbus::si::request::LimitBatteryInvert";
};
template <>
class Serializer<catta::modbus::si::request::LimitBatteryInvert>
{
  public:
    using ToString = catta::tostring::json::ToString<catta::modbus::si::request::LimitBatteryInvert>;
