...
{
template <>
class GetName<catta::modbus::si::request::Request>
{
  public:
    static constexpr std::string_view name = "catta::modbus::si::request::Request";
};
template <>
class Serializer<catta::modbus::si::request::Request>
{
  public:
    using ToString = catta::tostring::json::ToString<catta::modbus::si::request::Request>;
