...
{
template <>
class GetName<catta::modbus::si::request::ConstantVoltage>
{
  public:
    static constexpr std::string_view name = "catta::modbus::si::request::ConstantVoltage";
};
template <>
class Serializer<catta::modbus::si::request::ConstantVoltage>
{
  public:
    using ToString = catta::tostring::json::ToString<catta::modbus::si::request::ConstantVoltage>;
