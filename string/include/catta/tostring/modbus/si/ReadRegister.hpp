...
{
template <>
class GetName<catta::modbus::si::ReadRegister>
{
  public:
    static constexpr std::string_view name = "catta::modbus::si::ReadRegister";
};
template <>
class Serializer<catta::modbus::si::ReadRegister>
{
  public:
    using ToString = catta::tostring::json::ToString<catta::modbus::si::ReadRegister>;
