...
{
template <>
class GetName<catta::modbus::si::Date>
{
  public:
    static constexpr std::string_view name = "catta::modbus::si::Date";
};
template <>
class Serializer<catta::modbus::si::Date>
{
  public:
    using ToString = catta::tostring::json::ToString<catta::modbus::si::Date>;
