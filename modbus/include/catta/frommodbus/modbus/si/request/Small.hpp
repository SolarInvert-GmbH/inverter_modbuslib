...
class Parser<catta::modbus::si::request::Small>
{
  public:
    ...
    [[nodiscard]] constexpr std::tuple<Error, catta::parser::InputHandled> read(const Input& input) noexcept
    {
        ...
        const auto function = [next, input, error](std::uint8_t& v)
        {
    ...
    [[nodiscard]] constexpr Output data() const noexcept { return _state == DONE ? Output::create(_function) : Output::empty(); }
