...
template <>
class catta::random::Create<catta::modbus::sunspec::ScaledValue4U16>
{
  public:
    Create(Random& random) : _value(create(random)) {}
    operator catta::modbus::sunspec::ScaledValue4U16() const { return _value; }

  private:
    catta::modbus::sunspec::ScaledValue4U16 _value;
    static catta::modbus::sunspec::ScaledValue4U16 create(Random& random)
    {
        return catta::modbus::sunspec::ScaledValue4U16::create(
